...
const cargarproductos = ()=> {
    //productos
    for(item of boxes){
        let itemList = "<li class='bg-white shadow rounded overflow-hidden group'>" +
        "<div class='relative'>" +
            "<img src='../assets/images/Wow001.jpg' class='w-full' alt=''>" +
            ...
            "<div class='pt-4 pb-3 px-4'>" +
                "<a href='#'>" +
                    "<h4 class='uppercase font-medium text-xl mb-2 text-gray-800 hover:text-primary transition'>" + item + "</h4>" +
                "</a>" +
